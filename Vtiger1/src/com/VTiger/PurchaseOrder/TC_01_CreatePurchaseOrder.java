...
public class TC_01_CreatePurchaseOrder {
	...
	public void createPurchaseTest() {
		...
		driver.findElement(By.id("email")).sendKeys(lib.getExcelData("Vendor", 2, 1));
		...
		driver.findElement(By.id("category")).sendKeys(lib.getExcelData("Vendor", 2, 5));

		driver.findElement(By.id("phone")).sendKeys(lib.getExcelData("Vendor", 2, 4));

		driver.findElement(By.name("website")).sendKeys(lib.getExcelData("Vendor", 2, 2));
		...
		driver.findElement(By.name("subject")).sendKeys(lib.getExcelData("Purchase", 1, 0));
		...
		driver.findElement(By.id("tracking_no")).sendKeys(lib.getExcelData("Vendor", 1, 1));
