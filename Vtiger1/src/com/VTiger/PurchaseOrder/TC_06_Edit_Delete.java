...
public class TC_06_Edit_Delete 
{
	...
	public void editOrderTest() {
		...
		driver.findElement(By.xpath("//span[@vtfieldname='subject']/preceding-sibling::a[text()='Mi phone']")).click();
		...
		System.out.println(driver.findElement(By.xpath("//span[@class='genHeaderSmall']")).getText());
	}
